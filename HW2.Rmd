...
Based on the results obtained in the previous section, $k=4$ is selected as the optimal number of clusters, and the k-means algorithm is applied to the scaled dataset. The resulting clusters are interpreted using descriptive statistics as follows:
